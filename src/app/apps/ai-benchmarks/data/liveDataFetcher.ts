...
const PROVIDER_PATTERNS: Array<{ pattern: RegExp; info: ProviderInfo }> = [
  ...
  {
    // Meta's post-Llama line: Muse Spark (closed) and Muse Glimmer (open weights)
    pattern: /muse[-\s]?glimmer/i,
    info: { name: "Meta",             color: "text-sky-600 dark:text-sky-400",        isOpenSource: true,  canRunLocally: true  },
  },
  {
    pattern: /muse/i,
    info: { name: "Meta",             color: "text-sky-600 dark:text-sky-400",        isOpenSource: false, canRunLocally: false },
  },
  {
    pattern: /^seed[-\s]?\d|doubao/i,
    info: { name: "ByteDance",        color: "text-teal-600 dark:text-teal-400",      isOpenSource: false, canRunLocally: false },
  },
  {
    pattern: /^ling[-\s]?\d|inclusionai/i,
    info: { name: "InclusionAI",      color: "text-fuchsia-600 dark:text-fuchsia-400",isOpenSource: true,  canRunLocally: true  },
  },
  {
    pattern: /deepseek/i,
