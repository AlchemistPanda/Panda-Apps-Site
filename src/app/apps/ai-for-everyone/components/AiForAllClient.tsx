...
function AppContent() {
  ...
  useEffect(() => {
    fetch("/api/ai-for-everyone/sessions")
      .then((r) => r.json())
    ...
    <div className="relative">
      ...
      >
        <div className="max-w-7xl mx-auto px-5 h-16 flex items-center justify-between gap-4">
          ...
          <Link href="/apps/ai-for-everyone" className="flex items-center gap-2 group">
            <div className="relative">
            ...
            <div className="hidden sm:block">
              <p className="text-[15px] font-bold leading-tight text-white tracking-wide">AI <span className="ai4all-grad-text">for Everyone</span></p>
      ...
      <footer className="relative z-10 mt-12 border-t border-[var(--a-line)] bg-[#030014]/60 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-5 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-bold text-sm text-white">AI for Everyone</p>
          ...
          <div className="flex items-center gap-4 text-xs">
            ...
            <Link
              href="/apps/ai-for-everyone/admin"
