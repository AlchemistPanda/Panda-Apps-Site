...
import { verifyAdminToken, getAdminToken } from "@/lib/ai4all";
import crypto from "crypto";

export const dynamic = "force-dynamic";

// POST /api/ai-for-everyone/upload  (admin only — upload image to Cloudinary)
